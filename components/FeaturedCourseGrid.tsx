    ...
    <section className="py-12">
      <div className="container mx-auto px-4">
        ...
        {lastTwoCourses.map((course) => (
          <div
            key={course._id}
            className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-gradient-to-br from-primary/10 via-primary/5 to-background rounded-xl border overflow-hidden transition-all hover:shadow-lg p-6 mb-8"
          >
            {/* Left Side: Thumbnail */}
